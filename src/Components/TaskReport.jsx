...
function TaskReport() {
  ...
  return (
    <div className='h-[38%] bg-slate-300 p-5 flex flex-col gap-3'>
      <div className=' rep rounded-lg  text-center flex justify-around items-center p-2 bg-red-900 text-yellow-50 font-bold'>
        <h1>Employee Name </h1>
     ...
     <div className=' rep flex  flex-col text-center h-[90%] overflow-scroll gap-3'>
      ...
      <div key={idx}  className=' rounded-lg flex justify-around p-2 bg-red-900 text-yellow-50 font-bold' >
       ...
       <h1>{employees.taskreport.total}</h1>
     </div> 
